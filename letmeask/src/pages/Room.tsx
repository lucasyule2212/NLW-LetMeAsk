            ...
            return (
              ...
              > 
                {!userQuestion.isAnswered&&
                  <button
                  className={`like-button ${userQuestion.likeId?'liked':''}`}
                  type="button"
                  aria-label="Marcar como Like!"
                  onClick={()=>{handleLike(userQuestion.id,userQuestion.likeId)}}
                  > 
                    {userQuestion.likeCount>0&&<span>{userQuestion.likeCount}</span>}
